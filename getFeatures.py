...
arch['mda'] = {}
arch['mda']['drug'] = {}
arch['mda']['drug'] = {1: [10*100],
                        2: [10*1000, 10*100, 10*1000],
                        3: [10*1000, 10*500, 10*100, 10*500, 10*1000],
                        4: [10*1000, 10*500, 10*200, 10*100, 10*200, 10*200, 10*1000],
                        5: [10*1000, 10*800, 10*500, 10*200, 10*100, 10*200, 10*500, 10*800, 10*1000],
                        }
